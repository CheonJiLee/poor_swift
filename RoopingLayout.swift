...
@objc public protocol RoopingLayoutDelegate:UICollectionViewDelegate {
...
open class RoopingLayout: UICollectionViewLayout {
    ...
    fileprivate weak var delegate: RoopingLayoutDelegate?  {
        get {
            return collectionView?.delegate as? RoopingLayoutDelegate
        }
    }
