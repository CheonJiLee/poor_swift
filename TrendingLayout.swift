...
@objc public protocol TrendingLayoutDelegate:UICollectionViewDelegate {
...
open class TrendingLayout: UICollectionViewLayout {
    ...
    fileprivate weak var delegate: TrendingLayoutDelegate?  {
        get {
            return collectionView?.delegate as? TrendingLayoutDelegate
        }
    }
