...
class RoopingCollectionView: UIViewController, UICollectionViewDataSource,UIViewControllerTransitioningDelegate, RoopingLayoutDelegate,ButtonCellDelegate3 {
...
//    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Rooping", for: indexPath) as! RoopingCollectionViewCell
    ...
    func loadCardView(){
        Alamofire.request("http://www.roop.xyz/api/look/getRooping?access_token=\(self.getToken)", method: .post).responseJSON{ response in
            print("++++++++++++++++++++rooping++++++=")
            print(response)
