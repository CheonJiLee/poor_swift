...
class HomeViewController: UIViewController, UICollectionViewDataSource, UIViewControllerTransitioningDelegate, HomeLayoutDelegate, ButtonCellDelegate2 {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        //self.tabBarController?.tabBar.tintColor = UIColor.rgb(250, green: 202, blue: 57)
        //self.tabBarController?.tabBar.barTintColor = UIColor.rgb(250, green: 202, blue: 57)
            ...
            if let JSON = response.result.value as! [AnyObject]! {
                if JSON.count > 0{
                    ...
                    for i in 0..<JSON.count {
                        ...
                        cardView.likeStatus = JSON[i]["lookStatus"] as? Int
