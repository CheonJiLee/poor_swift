...
@objc public protocol HomeLayoutDelegate:UICollectionViewDelegate {
...
open class HomeLayout: UICollectionViewLayout {
    ...
    fileprivate weak var delegate: HomeLayoutDelegate?  {
        get {
            return collectionView?.delegate as? HomeLayoutDelegate
        }
    }
